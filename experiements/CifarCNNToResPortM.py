...
filteredDS = filterDataSetForTwoModels(cifarCNN, cifarPORT, loaderCifar, False, False)
...
admixAttack = AdmixAttackModified(model=cifarCNN, image_width=32, image_height=32)
vmiAttack = VMIAttackModified(model=cifarCNN)
...
maxModifiedErrList = []
for eps in epsilons:
    apgdAttack = APGDAttackModified(predict=cifarCNN, eps=eps / 255, device=device, is_Vt=False, alphaL2=10)
