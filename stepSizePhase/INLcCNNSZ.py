...
for alphaVal in alphas:
    ...
    admixAttack = AdmixAttackC(model=imagenetteLinear, image_width=160, image_height=160, image_resize=180, momentum=1.0, alpha=alphaVal)
    vmiAttack = VMIAttackC(model=imagenetteLinear, momentum=1.0, alpha=alphaVal, beta=1.5)
    for eps in epsilons:
