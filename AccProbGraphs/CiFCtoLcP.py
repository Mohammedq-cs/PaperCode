...
filteredDS = filterDataSetForTwoModels(cifarFC, cifarLinear, loaderCifar, False, False)
...
for eps in epsilons:
    ...
    for batch_idx, (inputs, targets) in enumerate(floader):
        ...
        for index, threshold in enumerate(steps):
            ...
            correctAPGDBBFilteredAdvEps, batch_size = computeAcc(cifarLinear, apgdAdvFEps, targets, is_Vt=False)
            correctAdmixBBFilteredAdvEps, batch_size = computeAcc(cifarLinear, admixAdvFEps, targets, is_Vt=False)
            correctVMIBBFilteredAdvEps, batch_size = computeAcc(cifarLinear, vmiAdvFEps, targets, is_Vt=False)
            ...
            correctAPGDWBFilteredAdvEps, batch_size = computeAcc(cifarFC, apgdAdvFEps, targets, is_Vt=False)
            correctAdmixWBFilteredAdvEps, batch_size = computeAcc(cifarFC, admixAdvFEps, targets, is_Vt=False)
            correctVMIWBFilteredAdvEps, batch_size = computeAcc(cifarFC, vmiAdvFEps, targets, is_Vt=False)
            ...
            correctAPGDBBFilteredAdv, batch_size = computeAcc(cifarLinear, apgdAdvF, targets, is_Vt=False)
            correctAdmixBBFilteredAdv, batch_size = computeAcc(cifarLinear, admixAdvF, targets, is_Vt=False)
            correctVMIBBFilteredAdv, batch_size = computeAcc(cifarLinear, vmiAdvF, targets, is_Vt=False)
            ...
            correctAPGDWBFilteredAdv, batch_size = computeAcc(cifarFC, apgdAdvF, targets, is_Vt=False)
            correctAdmixWBFilteredAdv, batch_size = computeAcc(cifarFC, admixAdvF, targets, is_Vt=False)
            correctVMIWBFilteredAdv, batch_size = computeAcc(cifarFC, vmiAdvF, targets, is_Vt=False)
