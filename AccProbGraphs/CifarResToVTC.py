...
admixAttack = AdmixAttackC(model=cifarResNet, image_width=32, image_height=32, momentum=1.0, alpha=1.6)
vmiAttack = VMIAttackC(model=cifarResNet, momentum=1.0, alpha=1.6, beta=1.5)
autoPGDErrList = []
admixErrList = []
vmiErrList = []
maxDecErrList = []
