...
for eps in epsilons:
    ...
    for batch_idx, (inputs, targets) in enumerate(floader):
        ...
        for index, threshold in enumerate(steps):
            ...
            correctAPGDBBFilteredAdv, batch_size = computeAcc(resnet18Cifar, apgdAdvF, targets, is_Vt=False)
            correctAdmixBBFilteredAdv, batch_size = computeAcc(resnet18Cifar, admixAdvF, targets, is_Vt=False)
            correctVMIBBFilteredAdv, batch_size = computeAcc(resnet18Cifar, vmiAdvF, targets, is_Vt=False)
