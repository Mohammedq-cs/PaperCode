...
pairs = [(1, 10), (2, 10), (2, 20), (2, 40), (4, 10), (4, 20), (4, 40), (6, 10), (6, 20), (10, 40), (10, 10), (10, 20), (10, 40)]
for (coef, iters) in pairs:
    print("coef=", coef, "iters=", iters)
    admixAccList = []
    vmiAccList = []
    admixAttack = AdmixAttackMult(model=imagenetteResNet, image_width=160, image_height=160, image_resize=180, momentum=1.0, num_iter=iters)
    vmiAttack = VMIAttackMult(model=imagenetteResNet, momentum=1.0, beta=1.5, num_iters=iters)
    for eps in epsilons:
        # print("eps=", eps)
        admixCorrect = 0
        vmiCorrect = 0
